 ...
 */
 ...
 #include <LiquidCrystal_I2C.h>
  ...
  const char* url1 = "/apps/thinghttp/send_request?api_key=################";     //Change this URL Cases
  const char* url2 = "/apps/thinghttp/send_request?api_key=################";   //Deaths
  const char* url3 = "/apps/thinghttp/send_request?api_key=################";   //Recovered
...
//    lcd.backlight();
    ...
    lcd.setCursor(0, 1);
    lcd.print("By Aditya Sharma");  //Change Name if you want
